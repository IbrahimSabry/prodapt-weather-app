...
export const LocationsReducer = createReducer(
  initialAppState,
  on(AppActions.loadLocationsData, state => ({ ...state, error: null, loading: true })),
...
export const SelectedLocationReducer = createReducer(
  initialAppState,
  on(AppActions.loadSelectedLocation, (state, { data }) => ({ ...state, data: data, }))
);

export const weatherReducer = createReducer(
  initialAppState,
  on(AppActions.loadWeatherData, state => ({ ...state, error: null, loading: true })),
