...
export const loadLocationsDataFailure = createAction('[Locations] Load Data Failure', props<{ error: unknown }>());
...
export const loadWeatherDataFailure = createAction('[Weather] Load Data Failure', props<{ error: unknown }>());
